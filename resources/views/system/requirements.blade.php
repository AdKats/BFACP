            ...
            <div class="error-page">
                <div class="error-content" style="margin-left: 0px">
                    <h4>
                        ...
                        <i class="fa fa-warning text-danger"></i> Server is running PHP
                        version <?php echo phpversion();?>, 5.5 or higher required.
                        <?php else: ?>
                        <i class="fa fa-check text-success"></i> Server is running PHP
                        version <?php echo phpversion();?> and satisfies PHP requirement.
                        <?php endif;?>
                    </h4>
                    <h4>
