            ...
            <div class="box-body">
                ...
                <div ng-switch="admin.action">
                    ...
                    <div ng-switch-when="teamswitch">
                        ...
                        <div class="form-group">
                            <p>
                                <span ng-bind="selectedPlayers.length"></span>
                                player<span ng-if="selectedPlayers.length != 1">s</span> will be moved to the
                                <span ng-bind="getTeam(admin.actions.teamswitch.team)" class="badge bg-purple"></span>
                                and placed in
