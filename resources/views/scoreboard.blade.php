        ...
        <div class="row" ng-if="requestError">
            <div class="col-xs-12">
                <alert type="error">
                    ...
                    The request couldn't complete due to a server side error. Please choose another server or
                    <a href="javascript://" ng-click="switchServer()">retry</a>. Notify an administrator if this error
                    persists.
                </alert>
            </div>
        </div>
...
@section('scripts')
    ...
    <script type="text/ng-template" id="warning-dialog.html">
        ...
        <div class="modal-body" ng-idle-countdown="countdown" ng-init="countdown = 60">
            <p>Scoreboard will be disabled in <span class="label label-danger">@{{countdown}}</span>
                <span ng-pluralize="" count="countdown" when="{'one': 'second', 'other': 'seconds' }"></span>.</p>
