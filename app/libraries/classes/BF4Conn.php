...
class BF4Conn
{
    ...
    function __construct($params = array()) {
        ...
        $this->_globalVars = array(
            "mapsFileXML" => app_path() . "/thirdparty/bf4/mapNames.xml",
            "playmodesFileXML" => app_path() . "/thirdparty/bf4/playModes.xml",
            "squadnamesFileXML" => app_path() . "/thirdparty/bf4/squadNames.xml",
            "teamnamesFileXML" => app_path() . "/thirdparty/bf4/teamNames.xml",
