...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            {{ Form::open(array('action' => array('ADKGamers\\Webadmin\\Controllers\\Admin\\AdKats\\RolePermsController@update', $role->role_id), 'method' => 'put')) }}
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-block">
                            ...
                            {{ Form::text('role_name', $role->role_name, ['class' => 'form-control', 'required' => 'required', 'ng-model' => 'role.name', 'ng-init' => 'role.name = "' . $role->role_name . '"']) }}
                        </div>
                        <br>
                        <div class="form-block">
            ...
            <div class="box-footer clearfix">
                ...
                {{ link_to_action('ADKGamers\\Webadmin\\Controllers\\Admin\\AdKats\\RolePermsController@show', 'Cancel Update', [$role->role_id], ['class' => 'btn btn-primary']) }}
